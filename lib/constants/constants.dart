...
const String login = '/delivery/auth/login';
const String logout = '/delivery/auth/logout';
const String signUp = '/delivery/auth/signUp';
const String update = '/delivery/update';
const String userData = '/delivery/auth/me';
const String updatePassword = '/delivery/update/password';
const String updateImage = '/delivery/update/image';
